    ...
    def execute_model(
        ...
        if model_input.is_prompt:
            ...
            if 1: 
                ...
                chot_lr = float(os.environ.get("CHOT_LR", "0.01"))
                ...
                try:
                    ...
                    # 在优化开始前初始化Adam参数
                    print("DEBUG - Creating Adam optimizer parameters") 
                    ...
                    for step in range(chot_steps):
                        ...
                        try:
                            print("DEBUG - Applying Adam update")
                            step += 1
                            ...
                            print(f"DEBUG - Adam moments: m_mean={self.adam_m.mean().item()}, "
                                  f"v_mean={self.adam_v.mean().item()}")
                            
                        except Exception as e:
                            print(f"DEBUG - Error in Adam parameter update: {e}")
                            raise
